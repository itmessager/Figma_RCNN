...
def process_detector_func(models, image_bgr, args):
    ...
    # Extract person detection result
    people_results = [r for r in obj_results if r.class_id == 1]
    ...
    image_bgr = draw_final_outputs(image_bgr, people_results, show_ids=show_ids)
