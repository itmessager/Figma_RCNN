...
@under_name_scope()
def encode_bbox_target(boxes, anchors):  # ok
    """
    Args:
        boxes: (..., 4), float32
        anchors: (..., 4), float32
...
class RPNAnchors(namedtuple('_RPNAnchors', ['boxes', 'gt_labels', 'gt_boxes'])):  # all_anchor, anchor_label, anchor_boxes
    """
...
if __name__ == '__main__':
    ...
    print(tf.image.crop_and_resize(
        image[None, :, :, None],  # batch,height,width,depth
