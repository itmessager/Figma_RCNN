...
class ResNetC4Model(DetectionModel):
    ...
    def build_graph(self, *inputs):
        ...
        # Mask
        person_boxes_on_featuremap = final_person_boxes * (1.0 / cfg.RPN.ANCHOR_STRIDE)
        person_roi_resized = roi_align(featuremap, person_boxes_on_featuremap, 14)
    ...
    if args.predict:
        ...
        pred = OfflinePredictor(PredictConfig(
            ...
            output_names=['output/boxes', 'output/scores', 'output/labels', 'output/masks',
                          'mul_1', 'person_boxes', 'stack','maskrcnn/conv/output',
                          'roi_align/AvgPool', 'roi_align_1/AvgPool','Tile_1',
                          'Select', 'group2/block5/output',
                          ]))
