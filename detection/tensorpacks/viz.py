...
from detection.tensorpacks.utils.np_box_ops import iou as np_iou
...
def draw_final_outputs(img, results, show_ids=None):
    """
    Args:
    ...
    if show_ids is not None:
        ...
        results = [r for r in results if r.class_id in show_ids]
