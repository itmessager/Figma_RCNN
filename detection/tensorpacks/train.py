...
from detection.tensorpacks.data import (
    ...
    get_all_anchors, get_all_anchors_fpn, get_wider_dataflow, get_wider_boxes)
...
class ResNetC4Model(DetectionModel):
    ...
    def build_graph(self, *inputs):
        ...
        # turned the wider box style to coco box style
...
if __name__ == '__main__':
    ...
    # train part
        ...
        train_dataflow = get_wider_boxes()   # get the wider datasets
