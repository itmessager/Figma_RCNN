# Borrowed from HyperFace project. Not really being used rigth now
...
def draw_loss_graph(train_loss_list, test_loss_list, train_epoch_list=None,
    ...
    ax.plot(test_epoch, test_loss, label='test.py', color=test_color)
    ...
    if test_loss.shape[0] > 0:
        ...
        draw_annotate('min test.py loss: %0.3f' % y, x, y, test_color)
